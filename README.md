...
File names are the NASDAQ orderbook IDs. For stock names, refer to the orderbookIDs directory. 

Norwegian stocks are all lumped under the First North GM Norway Trading List, which contains main market stocks too. 
